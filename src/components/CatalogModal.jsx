...
const categories = {
  ...
  otros: {
    ...
    products: [
      ...
      { id: 'torta-oreo', name: 'Torta Oreo', tag: 'Repostero', weight: '6 a 8 porciones', price: 800, description: 'Postre repostero con Oreos, crema y chocolate. Una opción irresistible para los amantes del chocolate.', img: '/catalogo/torta-oreo.png' },
      ...
      { id: 'torta-selvanegra', name: 'Selva Negra', tag: 'Mini Cake', weight: '4 porciones', price: 700, description: 'Mini cake selva negra con chocolate, crema y cerezas. Un clásico de la repostería.', img: '/catalogo/torta-selvanegra.png' },
