...
const categories = {
  familia: {
    ...
    products: [
      ...
      { id: 'familiar-clasica', name: 'Torta Chajá Especial 1200 gr', tag: 'Clásico', weight: '1,2 kg · Durazno o Frutilla', price: 1150, description: 'Torta Chajá especial clásico. Merengue característico, bizcochuelo, durazno o frutilla y chantilly. Hasta 45 días en heladera entre 4 y 7°C.', img: '/catalogo/familia-clasica.webp' },
      ...
      { id: 'familiar-especial', name: 'Torta Chajá Frágil 1500 gr', tag: 'Especial', weight: '1,5 kg · Durazno, Chocolate o DDL', price: 1590, description: 'La torta más grande. Merengue, bizcochuelo, durazno o chocolate o dulce de leche y crema vainilla. Hasta 45 días en heladera entre 4 y 7°C.', img: '/catalogo/familia-especial.webp' },
    ],
  },
  helado: {
    label: 'Chajá Helado',
